...
right-click menu; the **TRN** input transposes everything at 1V/oct. By
default the scale and root **follow Base64's global key** — picking a local
one overrides the follow switch. Like all companion modules it is pure CV —
no Launchpad chain, blue accent.
